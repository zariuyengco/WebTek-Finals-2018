<%-- 
    Document   : login
    Created on : 05 21, 18, 6:08:07 PM
    Author     : user
--%>
						...
						<div class="cta-inner text-center rounded">
							...
							<div class="col-xl-9 col-lg-10 mx-auto">
								<div class="bg-faded rounded p-5">
									<a class="btn btn-outline-secondary" href="">Service Provider</a>
									<a class="btn btn-outline-secondary" href="">Admin</a>
									<a class="btn btn-outline-secondary" href="../customerhome.jsp">Customer</a>
								</div>
							</div>
						</div>
					</div>
